...
class EfficientNet_Parallel(BaseBackbone):
    ...
    def __init__(self,
                 num_channels = 1,
                 seperate_block = 1, # seperate after this block so we'll have parallel part in the model - partA , partB
                 arch='b0',
                 drop_path_rate=0.,
                 out_indices=(6, ),
                 frozen_stages=0,
        ...
        super(EfficientNet_Parallel, self).__init__(init_cfg)
        ...
        self.seperate_block = seperate_block
    ...
    def forward(self, x): #all channels
        outs = []
    ...
    def train(self, mode=True):
        super(EfficientNet_Parallel, self).train(mode)
        self._freeze_stages()

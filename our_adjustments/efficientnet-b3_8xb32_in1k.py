...
work_dir = '/home/maya/projA/runs/subpixel_64_8_max_epoch_400' #'/home/maya/projA/runs/original_run_effecientnet' #TODO
dataset_prefix = '/home/maya/Pictures/projA_pics/subpixel_64_8' #'/home/maya/Pictures/projA_pics/dataset_balanced'#TODO
multi_image_flag = True
multi_num= 8 #number of channels in the input
max_epoch_num = 400
num_of_train = 8/multi_num #number of epochs and validation for them, relevant when flag is false
...
workflow = [('train', num_of_train),('val',1)]
